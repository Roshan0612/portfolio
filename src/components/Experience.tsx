...
const Experience = () => {
  ...
  return (
    <section
      id="experience"
      className="w-full py-20 bg-gradient-to-b from-black to-gray-900"
    >
      <div className="max-w-[1920px] mx-auto px-3 sm:px-8 lg:px-16 xl:px-24">
        ...
        <div className="text-center mb-20 animate-fade-in-up">
          ...
          <p className="text-gray-400 max-w-2xl mx-auto text-lg">
            My professional journey showcasing growth, impact, and technical
            expertise across different organizations
          </p>
        </div>
              ...
              >
                ...
                >
                  ...
                  <div className="glass rounded-2xl p-8 card-hover shadow-xl border border-gray-800/50 hover:border-teal-400/50 transition-all group">
                    ...
                    {/* Description */}
                    <p className="text-gray-300 mb-6 leading-relaxed text-lg group-hover:text-gray-200 transition-colors">
                      {exp.description}
                    </p>
                    ...
                    <div className="mb-6">
                      ...
                      <h5 className="text-white font-bold mb-4 text-sm uppercase tracking-wide">
                        Key Achievements
                      </h5>
                      ...
                      <ul className="space-y-3">
                        ...
                        {exp.achievements.map(
                          (achievement, achIndex) => (
                            <li
                              key={achIndex}
                              className="text-gray-300 text-sm flex items-start leading-relaxed hover:text-gray-200 transition-colors"
                            >
                              <span className="text-teal-400 mr-3 mt-1 flex-shrink-0">
                                ▸
                              </span>
        ...
        <div className="text-center mt-20">
          ...
          <button
            ...
            className="bg-gradient-to-r from-teal-500 to-gray-700 hover:from-teal-600 hover:to-gray-800 text-white px-10 py-3 rounded-lg font-semibold transition-all duration-300 hover:scale-105 active:scale-95 shadow-lg hover:shadow-xl btn-hover"
          >
            Download Resume
          </button>
