...
const Hero = () => {
  ...
  return (
    <section id="hero" className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 pt-20 relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        ...
        <div className="absolute bottom-20 right-10 w-72 h-72 bg-gradient-to-br from-blue-500/20 to-blue-500/5 rounded-full blur-3xl animate-float-delayed"></div>
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-gradient-to-br from-purple-500/10 to-pink-500/5 rounded-full blur-3xl opacity-50"></div>
      </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start items-center mb-12 animate-fade-in-up stagger-3">
              <button
                className="bg-gradient-to-r from-teal-400 to-blue-500 text-white px-8 py-3 rounded-lg font-semibold transition-all duration-300 hover:from-teal-500 hover:to-blue-600 shadow-lg hover:shadow-xl hover:scale-105 active:scale-95 btn-hover group relative overflow-hidden"
                onClick={handleDownload}
              >
                <span className="relative z-10">Download Resume</span>
                <div className="absolute inset-0 bg-gradient-to-r from-blue-600 to-teal-500 opacity-0 group-hover:opacity-20 transition-opacity duration-300"></div>
              </button>
            ...
            <div className="flex justify-center lg:justify-start space-x-6 animate-fade-in-up stagger-4">
              <a
                ...
                className="p-3 rounded-full text-gray-400 hover:text-teal-400 bg-slate-800/50 hover:bg-teal-400/10 transition-all duration-300 transform hover:scale-125 border border-slate-700/50 hover:border-teal-400/30 group"
                aria-label="GitHub"
              >
              ...
              <a
                ...
                className="p-3 rounded-full text-gray-400 hover:text-blue-400 bg-slate-800/50 hover:bg-blue-400/10 transition-all duration-300 transform hover:scale-125 border border-slate-700/50 hover:border-blue-400/30 group"
                aria-label="LinkedIn"
              >
              ...
              <a
                ...
                className="p-3 rounded-full text-gray-400 hover:text-orange-400 bg-slate-800/50 hover:bg-orange-400/10 transition-all duration-300 transform hover:scale-125 border border-slate-700/50 hover:border-orange-400/30 group"
                aria-label="Email"
              >
          ...
          <div className="flex justify-center lg:justify-end">
            <div className="relative">
              <div className="w-80 h-80 lg:w-96 lg:h-96 rounded-full overflow-hidden border-4 border-teal-400 p-1 bg-gradient-to-r from-teal-400 to-blue-500 animate-pulse-slow shadow-2xl">
              ...
              <div className="absolute -bottom-6 -left-6 w-6 h-6 bg-blue-500 rounded-full animate-float-delayed shadow-lg shadow-blue-500/50"></div>
